...
# Import and create Xnew from the sliced m
```{r Create Xnew}
...
D1_D2_split <- data_to_model %>% initial_split(prop = 0.5)
D1 <- training(D1_D2_split)
D2 <- testing(D1_D2_split)
svm_rbf_fit_CP <- train_model(D1)
```

# Save the model trained on D1
